      ...
      <nav className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden" id="mobile-menu">
            <div className="mobile-padding pt-4 pb-4 space-y-2 bg-white/95 backdrop-blur-sm border-t border-gray-200">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  ...
                  className={`tap-target block px-4 py-3 text-base font-medium tracking-wide rounded-md transition-colors
                    ${location === item.href ? "text-gray-900 bg-gray-100" : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"}`}
                >
                  {item.name}
                </Link>
              ))}
              ...
              <div className="pt-4 border-t border-gray-200">
                <div className="px-4 py-2 text-sm text-gray-500">Language</div>
                <button
                  onClick={() => {
                    setCurrentLanguage("KR");
                    setIsMobileMenuOpen(false);
                  ...
                  className={`tap-target block w-full px-4 py-3 text-base font-medium rounded-md transition-colors text-left
                    ${currentLanguage === "KR" ? "text-gray-900 bg-gray-100" : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"}`}
                >
                  한국어 (KR)
                </button>
                <button
