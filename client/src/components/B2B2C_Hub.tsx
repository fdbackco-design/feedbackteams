    ...
    <section className="relative py-8 sm:py-12 lg:py-20 min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4 sm:mb-6 lg:mb-8">
          <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-white mb-2 sm:mb-3" style={{ lineHeight: '1.2' }}>
            ...
            >
              <div className="bg-white rounded-lg shadow-lg p-3 sm:p-4">
                <div className="flex items-center mb-2">
                  ...
                  <div>
                    <h3 className="text-sm sm:text-base font-semibold text-black">B2B 제조사</h3>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-1">
                  <span className="px-2 py-0.5 bg-[#0F4C82]/10 text-[#0F4C82] rounded-full text-xs">전문 제조</span>
                  <span className="px-2 py-0.5 bg-[#0F4C82]/10 text-[#0F4C82] rounded-full text-xs">품질 관리</span>
                  <span className="px-2 py-0.5 bg-[#0F4C82]/10 text-[#0F4C82] rounded-full text-xs">OEM/ODM</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-[#0F4C82] rounded-lg shadow-lg p-3 sm:p-4 text-white">
                <div className="flex items-center mb-2">
                  ...
                  <div>
                    <h3 className="text-sm sm:text-base font-semibold">FeedBack 유통 허브</h3>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-1">
                  <span className="px-2 py-0.5 bg-white/20 text-white rounded-full text-xs">전국 유통망</span>
                  <span className="px-2 py-0.5 bg-white/20 text-white rounded-full text-xs">물류 최적화</span>
                  <span className="px-2 py-0.5 bg-white/20 text-white rounded-full text-xs">브랜드 마케팅</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white rounded-lg shadow-lg p-3 sm:p-4">
                <div className="flex items-center mb-2">
                  ...
                  <div>
                    <h3 className="text-sm sm:text-base font-semibold text-black">B2C 소비자</h3>
                  </div>
                </div>
                <p className="text-xs sm:text-sm text-gray-600 mb-2">
                  다양한 채널을 통해 소비자에게 최고의 제품과 서비스를 제공합니다
                ...
                <div className="flex flex-wrap gap-1">
                  <span className="px-2 py-0.5 bg-[#0F4C82]/10 text-[#0F4C82] rounded-full text-xs">온라인·오프라인</span>
                  <span className="px-2 py-0.5 bg-[#0F4C82]/10 text-[#0F4C82] rounded-full text-xs">홈쇼핑 연계</span>
                  <span className="px-2 py-0.5 bg-[#0F4C82]/10 text-[#0F4C82] rounded-full text-xs">글로벌 진출</span>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-white/80 leading-relaxed">
              제조사의 우수한 제품이 소비자에게 성공적으로 전달될 수 있도록,<br className="hidden sm:block" />
