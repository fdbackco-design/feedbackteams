        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-16">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div
                className="order-1"
                style={{ maxWidth: "536px", maxHeight: "405px" }}
              >
                <img
                  src={puzzleImage}
                  alt="고객·파트너 중심"
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="flex flex-col lg:flex-row lg:items-center mb-16 bg-white/70 p-4 rounded-xl backdrop-blur-sm gap-4">
            ...
            <p
              className="about-timeline-description leading-relaxed font-regular text-[#000000]"
        ...
        <div className="max-w-7xl mx-auto ">
          ...
          <div className="overflow-hidden">
            <div className="flex flex-col">
              ...
              <div className="to-accent p-12 text-black text-center flex flex-col justify-center items-center gap-2">
