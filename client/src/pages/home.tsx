    ...
    >
      ...
      <div className="fixed right-4 md:right-8 top-1/2 transform -translate-y-1/2 z-50">
        <div className="relative h-48">
          {/* Background line */}
          <div className="absolute right-0 top-0 w-0.5 h-full transition-all duration-500 bg-gray-500"></div>
          {/* Progress line */}
          <div 
            className="absolute right-0 top-0 w-0.5 transition-all duration-500 bg-primary"
            style={{ height: `${((currentSection + 1) / sections.length) * 100}%` }}
          ></div>
          {/* Section numbers */}
          <div className="absolute right-3 top-0 text-sm font-medium transition-all duration-500 text-gray-900">
            {String(currentSection + 1).padStart(2, '0')}
          </div>
          <div className="absolute right-3 bottom-0 text-sm font-medium transition-all duration-500 text-gray-600">
