        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
            <div className="max-w-4xl text-white">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white/90">피부에 감성을 입히다</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="group">
              <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <h3 className="text-2xl font-bold text-[#000000] mb-4 text-center">클린 포뮬러</h3>
            ...
            <div className="group">
              <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <h3 className="text-2xl font-bold text-[#000000] mb-4 text-center">감성 디자인</h3>
                <p className="text-lg text-gray-600 leading-relaxed mb-6 text-center">
            ...
            <div className="group">
              <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <h3 className="text-2xl font-bold text-[#000000] mb-4 text-center">글로벌 K-뷰티</h3>
                <p className="text-lg text-gray-600 leading-relaxed mb-6 text-center">
