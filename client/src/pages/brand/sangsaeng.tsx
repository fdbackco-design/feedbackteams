...
import { ArrowLeft, Heart, Globe, Smartphone, Building2, Users, MapPin, ArrowRight, Calendar } from "lucide-react";
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700 font-medium">맞춤형 건강 검진 패키지</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">전문의 상담 서비스</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">만성질환 관리 프로그램</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">예방 의학 솔루션</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">다국어 의료 통역 서비스</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">병원 예약 및 관리</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">의료 관광 패키지</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">24시간 응급 서포트</span>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-center text-[#0F4C82] font-semibold group-hover:translate-x-2 transition-transform duration-300 mt-6">
              ...
              <div className="bg-white rounded-2xl p-10 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">의료 콘텐츠 마케팅</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">다국어 브랜드 캠페인</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">글로벌 인플루언서 협업</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4C82] rounded-full mr-3"></div>
                      <span className="text-gray-700 font-medium">디지털 마케팅 솔루션</span>
                    </div>
                  </div>
                </div>
                <div className="flex items-center justify-center text-[#0F4C82] font-semibold group-hover:translate-x-2 transition-transform duration-300 mt-6">
