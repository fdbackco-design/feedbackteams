...
const translations = {
  KR: {
    ...
    "contact.info.address.content":
      "인천광역시 연수구 송도동 172-1 송도테크노파크IT센터, S동 3003호",
  ...
  EN: {
    ...
    "contact.info.address.content":
      "Room 3003, Building S, Songdo Technopark IT Center, 172-1, Songdo-dong, Yeonsu-gu, Incheon, Republic of Korea",
  ...
  TH: {
    ...
    "contact.info.address.content":
      "ห้อง 3003 อาคาร S ศูนย์ไอที ซงโด เทคโนพาร์ค 172-1 ซงโดดง เขตยอนซูกู เมืองอินชอน ประเทศเกาหลีใต้",
