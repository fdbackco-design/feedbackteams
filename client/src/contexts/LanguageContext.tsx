...
const translations = {
  ...
  TH: {
    ...
    "news.6.date": "2025.10.01",
    "news.6.title": "ASRAN เปิดตัวไลน์เครื่องครัวสเตนเลสระดับไฮเอนด์ 3 ซีรีส์",
    "news.6.summary":
      "แบรนด์เครื่องครัวระดับพรีเมียม ASRAN เปิดตัวไลน์อัพเครื่องครัวระดับไฮเอนด์อย่างเป็นทางการ ประกอบด้วยหม้อสเตนเลส 3 ใบ หม้อแรงดัน และกระทะทอด 3 ใบ",
    "news.6.content":
      "ประสบการณ์การทำอาหารระดับพรีเมียมด้วยเหล็ก SUS410 วิศวกรรมเยอรมันและฐาน 3 ชั้น\n\nFeedback (ซีอีโอ: ซองฮยอน จอง) ประกาศว่าแบรนด์เครื่องครัวพรีเมียม ASRAN ได้เปิดตัวไลน์เครื่องครัวสเตนเลสระดับไฮเอนด์อย่างเป็นทางการในวันที่ 1 ตุลาคม 2025\n\nไลน์อัพใหม่ประกอบด้วยหม้อสเตนเลส 3 ใบ หม้อแรงดัน และกระทะทอด 3 ใบ ใช้เหล็กสเตนเลส SUS410 บนพื้นฐานเทคโนโลยีเยอรมันและฐาน 3 ชั้น เพื่อเพิ่มประสิทธิภาพการนำความร้อนและความทนทานสูงสุด\n\n(ภาพ: ไลน์อัพเครื่องครัว ASRAN)\n\n<strong>โซลูชันการทำอาหารพรีเมียมจากเทคโนโลยีเยอรมัน</strong>\n\nเครื่องครัว ASRAN ถูกออกแบบให้ครอบคลุมตั้งแต่ครัวเรือนจนถึงมืออาชีพ ระบบควบคุมแรงดันคู่และชั้นนำความร้อนที่แม่นยำช่วยรักษาสมดุลอุณหภูมิระหว่างทำอาหาร เพื่อคงรสชาติและสารอาหารตามธรรมชาติของวัตถุดิบ\n\nสเตนเลส SUS410 มีความทนต่อการกัดกร่อนและการเปลี่ยนสีได้ดีเยี่ยม เงางามยาวนานหลังการล้าง จึงเหมาะอย่างยิ่งต่อการรักษาสุขอนามัยในครัว นอกจากนี้ฐาน 3 ชั้นยังช่วยกระจายความร้อนได้สม่ำเสมอกับทุกแหล่งความร้อน รวมถึงเตาแม่เหล็กไฟฟ้า ทำให้ทำอาหารได้อย่างสมบูรณ์แบบในทุกสภาพแวดล้อม\n\n<strong>ดีไซน์ที่ผสานทั้งฟังก์ชันและความงาม</strong>\n\nASRAN พัฒนาร่วมกับทีมออกแบบและเชฟมืออาชีพเพื่อเพิ่มความสะดวกในการใช้งานจริง ฟินิชกระจกเงาระดับพรีเมียมและเส้นสายที่เรียบหรูช่วยยกระดับบรรยากาศครัวโดยยังคงความใช้งานได้จริง\n\nด้ามจับถูกออกแบบตามหลักสรีรศาสตร์เพื่อลดภาระข้อมือเมื่อต้องทำอาหารนาน ๆ และปรับสมดุลงานถ่วงน้ำหนักให้เหมาะสม วาล์วระบายไอน้ำบนฝาแก้วช่วยให้ควบคุมกระบวนการทำอาหารได้อย่างมั่นใจ\n\nโฆษกของ Feedback กล่าวว่า “ASRAN ไม่ใช่แค่เครื่องครัว แต่คือพาร์ตเนอร์ของเชฟที่ยกระดับความสมบูรณ์ของจานอาหาร เราจะเดินหน้าพัฒนาผลิตภัณฑ์ที่ผสานนวัตกรรมทางเทคนิคกับงานดีไซน์อย่างต่อเนื่อง เพื่อก้าวสู่แบรนด์ที่เปลี่ยนการทำอาหารทุกวันให้เป็นศิลปะ”\n\nASRAN ชุดไฮเอนด์วางจำหน่ายแล้วผ่านร้านออนไลน์ทางการและช่องทางค้าปลีกชั้นนำ",

    "news.7.date": "2025.10.10",
    "news.7.title":
      "La Ceras เปิดตัวชุดกระเป๋าเดินทางลักชัวรี 4 ชิ้น สไตล์ฝรั่งเศส",
    "news.7.summary":
      "แบรนด์กระเป๋าเดินทางระดับพรีเมียม La Ceras ที่ผสมผสานกลิ่นอายฝรั่งเศสกับเทคโนโลยีสมัยใหม่ เปิดตัวชุดลักชัวรี 4 ชิ้น ขนาด 14, 20, 24 และ 28 นิ้ว อย่างเป็นทางการ",
    "news.7.content":
      "งานช่างฝรั่งเศสพบดีไซน์สมัยใหม่: โครงสร้างไฮบริด PP-PC น้ำหนักเบาแต่ทนทาน\n\nเมื่อวันที่ 10 ตุลาคม 2025 Feedback (ซีอีโอ: ซองฮยอน จอง) ประกาศเปิดตัวชุดกระเป๋าเดินทางลักชัวรี La Ceras (ลา เซราส) 4 ชิ้น (14, 20, 24, 28 นิ้ว) อย่างเป็นทางการ\n\nLa Ceras ผสานงานช่างฝรั่งเศสเข้ากับปรัชญาการออกแบบสมัยใหม่ เปลือกไฮบริด PP (โพลิโพรพิลีน) และ PC (โพลีคาร์บอเนต) ช่วยให้มีน้ำหนักเบาแต่แข็งแรงทนทาน\n\n(ภาพ: กระเป๋าเดินทาง La Ceras ระหว่างการใช้งาน)\n\n<strong>โซลูชันท่องเที่ยวพรีเมียมสไตล์เวิร์กชอปปารีส</strong>\n\nมีตั้งแต่ 14 ถึง 28 นิ้ว รองรับวัตถุประสงค์และระยะเวลาเดินทางที่หลากหลาย รุ่น 14 นิ้วออกแบบให้ผ่านข้อกำหนดพกพาขึ้นเครื่อง เหมาะกับทริประยะสั้นหรือทริปธุรกิจ ส่วนรุ่น 28 นิ้วเหมาะกับการเดินทางไกลและการบรรจุสัมภาระปริมาณมาก\n\nระบบล้อเงียบแบบตลับลูกปืน 210D มอบความลื่นไหลและมั่นคง เหมาะกับสภาพแวดล้อมที่ต้องการความเงียบ เช่น สนามบินและโรงแรม\n\nภายในเป็นโครงสร้างแยกเก็บ 2 ฝั่ง พร้อมซับกันน้ำคุณภาพสูง และซิป YKK เพื่อความทนทานและใช้งานได้จริง ช่วยจัดระเบียบเสื้อผ้าและของใช้ได้เป็นระบบ และปกป้องของภายในจากสภาพอากาศที่คาดไม่ถึง\n\n<strong>รายละเอียดพรีเมียมที่เพิ่มคุณค่าในการสะสม</strong>\n\nLa Ceras วางตัวเป็น “เพื่อนร่วมการเดินทาง” อย่างแท้จริง ทุกใบมีหมายเลขซีเรียลเฉพาะสำหรับยืนยันของแท้และเสริมคุณค่าในการสะสม ป้ายฉลากถ่ายทอดบรรยากาศเวิร์กชอปในปารีส ชัดเจนในอัตลักษณ์แบรนด์\n\nโทนสีดำเรียบหรูและเส้นสายที่สงบนิ่ง เหมาะทั้งธุรกิจและท่องเที่ยว วัสดุและงานประกอบระดับพรีเมียมช่วยเติมภาพลักษณ์หรูหราให้สมบูรณ์\n\n<strong>รุกตลาดต่างประเทศและดิวตี้ฟรี</strong>\n\nโฆษกของ Feedback กล่าวว่า “La Ceras มอบ ‘ศักดิ์ศรีแห่งการเดินทาง’ และจะเติบโตเป็นแบรนด์ท่องเที่ยวระดับพรีเมียมที่เติมเต็มเอกลักษณ์และสไตล์ของลูกค้า เรามีแผนเดินหน้าสู่ดิวตี้ฟรีสนามบินระดับโลกและขยายสู่ตลาดยุโรป”\n\nกระเป๋าเดินทางลักชัวรี La Ceras วางจำหน่ายแล้วทางร้านออนไลน์ทางการและพันธมิตรค้าปลีกหลัก",

    "news.8.date": "2025.10.13",
    "news.8.title":
      "Carvella เปิดตัวชุดมีดและเขียงสเตนเลสระดับพรีเมียม กลิ่นอายอิตาลี",
    "news.8.summary":
      "แบรนด์เครื่องครัวพรีเมียม Carvella ที่ได้รับแรงบันดาลใจจากงานช่างอิตาลี เปิดตัว Carvella Signature Set อย่างเป็นทางการ ประกอบด้วยชุดมีด 6 ชิ้น และเขียงสเตนเลส",
    "news.8.content":
      "ความแม่นยำในการหั่นสไตล์ช่างโลหะอิตาลีตอนเหนือ: ใบมีดเหล็กคาร์บอนสูงและเขียงสเตนเลส 304\n\nแบรนด์เครื่องครัวพรีเมียม Carvella ของ Feedback ประกาศเปิดตัว ‘Carvella Signature Set’ อย่างเป็นทางการในวันที่ 13 ตุลาคม 2025 ประกอบด้วยชุดมีด 6 ชิ้น และเขียงสเตนเลส\n\nCarvella สืบทอดงานช่างโลหะของช่างฝีมือทางตอนเหนือของอิตาลี มอบความแม่นยำในการหั่นและความทนทาน เซ็ตนี้ถูกพัฒนาเป็นโซลูชันระดับพรีเมียมสำหรับทั้งเชฟมืออาชีพและโฮมเชฟ\n\n(ภาพ: องค์ประกอบครบชุดของ Carvella Signature Set)\n\n<strong>ระบบการหั่นที่แม่นยำจากฝีมือช่างอิตาลี</strong>\n\nชุดมีดใช้เหล็กคาร์บอนสูง รักษาความคมและความทนทานได้ยาวนาน เมื่อเทียบกับสเตนเลสทั่วไป เหล็กคาร์บอนสูงมีความแข็งมากกว่า ช่วยให้หั่นได้แม่นยำและต้านทานการเสียรูป—คุณสมบัติที่ครัวมืออาชีพนิยมใช้\n\nด้ามจับทำจากวัสดุคอมโพสิตกันลื่น เพื่อการควบคุมที่มั่นคงในงานละเอียด ออกแบบตามหลักสรีรศาสตร์เพื่อลดภาระข้อมือ และปรับสมดุลน้ำหนักให้ใช้งานได้นานโดยไม่ล้า\n\nเขียงสเตนเลส 304 ที่รวมอยู่ในชุดมีความถูกสุขอนามัยและทนต่อการเปลี่ยนสี รักษาความสะอาดได้ยาวนาน ต่างจากเขียงไม้ที่มีความเสี่ยงการสะสมเชื้อแบคทีเรียน���อยกว่า และสามารถล้างด้วยเครื่องล้างจานได้ สะดวกต่อการดูแลรักษา\n\n<strong>รายละเอียดพรีเมียมขัดเงาด้วยมือ</strong>\n\nผลิตภัณฑ์ทุกชิ้นของ Carvella ผ่านการขัดเงาด้วยมือของช่าง เพื่อให้ได้ความเงางามและบาลานซ์อันเป็นเอกลักษณ์ โทนสเตนเลส-ดำเพิ่มความหรูหราให้ครัวทุกสไตล์ และแพ็กเกจของขวัญระดับพรีเมียมเพิ่มคุณค่าในการมอบเป็นของขวัญ\n\nชุดมีด 6 ชิ้นประกอบด้วย มีดเชฟ มีดขนมปัง มีดอเนกประสงค์ มีดปอกผลไม้ ที่ลับมีด และกรรไกรครัว ครอบคลุมสถานการณ์การทำอาหารที่หลากหลาย และทุกชิ้นสลักโลโก้ Carvella ชัดเจนในอัตลักษณ์แบรนด์\n\n<strong>ปรัชญาความยั่งยืนสู่การเติบโตระดับสากล</strong>\n\nโฆษกของ Feedback กล่าวว่า “Carvella ไม่ใช่เพียงเครื่องมือ แต่คือการเติมเต็มศิลปะแห่งการทำอาหาร เราจะสืบสานเทคนิคและอารมณ์แบบช่างอิตาลี เพื่อก้าวสู่แบรนด์ครัวระดับพรีเมียมในยุโรปและเอเชีย”\n\n“เรายังวางแผนยกระดับกระบวนการผลิตที่ยั่งยืนและวัสดุเป็นมิตรต่อสิ่งแวดล้อม เพื่อเติบโตเป็นแบรนด์พรีเมียมที่ให้ความสำคัญทั้งสิ่งแวดล้อมและคุณภาพ”\n\nCarvella Signature Set วางจำหน่ายแล้วผ่านร้านออนไลน์ทางการและช่องทางค้าปลีกหลัก",
    ...
    "asran.feature2.description":
      "เพิ่มประสิทธิภาพพลังงานด้���ยการนำความร้อนยอดเยี่ยม",
